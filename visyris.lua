...
gauge = {
{
    ...
    graph_fg_colour=0xff0000,      graph_fg_alpha=1,
    ...
    caption_fg_colour=0x000000,    caption_fg_alpha=0,
},
{
...
{
    name='execi 5 nvidia-settings -q [gpu:0]/UsedDedicatedGPUMemory -t',           arg='',                     max_value=1997,
    x=70,                          y=401,
    graph_radius=24,
    graph_thickness=12,
    graph_start_angle=180,
    graph_unit_angle=0.135,        graph_unit_thickness=0.135,
    graph_bg_colour=0xff0000,      graph_bg_alpha=0.3,
    graph_fg_colour=0xff0000,      graph_fg_alpha=1,
    hand_fg_colour=0xff0000,       hand_fg_alpha=1,
    txt_radius=40,
    ...
    txt_fg_colour=0x000000,        txt_fg_alpha=0,
    graduation_radius=28,
    graduation_thickness=0,        graduation_mark_thickness=0.135,
    graduation_unit_angle=27,
    graduation_fg_colour=0xFFFFFF, graduation_fg_alpha=0.3,
    caption='',
    caption_weight=1,              caption_size=0,
